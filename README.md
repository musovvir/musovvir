...
### Уже 3-ий год я занимаюсь frontend-разработкой.
...
### На данный момент параллельно фронту пишу пэт-проект, используя VK API на Dart/Flutter, где будут применены все навыки необходимые для уровня middle
