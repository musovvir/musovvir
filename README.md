...
### Уже 3-ий год я занимаюсь разработкой.
...
### На данный момент параллельно с работой на фронте пишу пэт-проект, используя VK API на Dart/Flutter, где будут применены все навыки необходимые для уровня middle
